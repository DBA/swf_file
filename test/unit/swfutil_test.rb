...
class TestSwfUtil < Test::Unit::TestCase
  context "SwfUtil module" do
    should "not be initializable" do
      assert_raises(NoMethodError) { SwfUtil.new }
    end
    
    context "Header reader" do
      should "require a file" do
        assert_raises(ArgumentError) { SwfUtil.read_header }
      end
