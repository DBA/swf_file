...
==Example
  header = SwfFile.header 'clicktag.swf' # load the file
  ...
  # You can also pass a block to SwfFile.header
  puts SwfFile.header 'clicktag.swf' { |h| puts h.duration }
  
  # It's also possible to create instances of SwfFile
  swf = SwfFile.new 'clicktag.swf'
  swf.header # => SwfHeader class instance equivalent to the return of SwfFile.header(<file>)
  swf.header.duration
  
  # Instances of SwfFile also receive blocks
  swf.header { |h| h.duration }
  
  # SwfFile instance helper method
